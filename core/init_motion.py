...
class InitMotion:
    ...
    def gen_motion_configs(self):
        ...
        if not motion_conf_dir.is_dir():
            motion_conf_dir.mkdir(parents=True)
    ...
    def gen_motion_conf(self):
        ...
        with open(f'{self.kmotion_dir}/core/motion_conf/motion.conf', 'w', encoding="utf-8") as f_obj1:
            f_obj1.write(f'''
# ------------------------------------------------------------------------------
...
''')
            ...
            for feed in self.camera_ids:
                f_obj1.write(f'camera {self.kmotion_dir}/core/motion_conf/camera{feed:02d}.conf\n')
    ...
    def gen_cameras_conf(self):
        ...
        for feed in self.camera_ids:
            with open(f'{self.kmotion_dir}/core/motion_conf/camera{feed:02d}.conf', 'w', encoding="utf-8") as f_obj1:
                f_obj1.write('''
# ------------------------------------------------------------------------------
# This config file has been automatically generated by kmotion
# Do __NOT__ modify it in any way.
